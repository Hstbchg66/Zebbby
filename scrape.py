...
# إعدادات الاتصال
bot_token = '7323437477:AAFfNcDHMvwNnlyolrtTIxKwBcktyO9nbrI'
admin_id = '7371519921'  # يجب استبداله بمعرف المدير الصحيح
api_id = '9615664'  # يجب استبداله بالمعرف API الخاص بك
api_hash = '32a7dd931eea1c701e2da971216b61b1'  # يجب استبداله بالهاش API الخاص بك
phone_number = '+201153262807'  # يجب استبداله برقم الهاتف الخاص بك
...
def send_welcome(message):
    ...
    button4 = types.InlineKeyboardButton("• 𝗗𝗘𝗩", url='https://t.me/XD_FB')
    button5 = types.InlineKeyboardButton("⮕", url='https://t.me/XD_FB')
    button6 = types.InlineKeyboardButton("ڤيـنـوم • VENOM", url='https://t.me/XD_FB')
...
●●●●●●●●●●●"""
            ...
            with open('Original_Scrap.txt', 'rb') as file:
                ...
                dev_button = telebot.types.InlineKeyboardButton(text="𝗗𝗘𝗩", url='https://t.me/XD_FB')
